...
react_2.storiesOf("New Wizard", module)
    ...
    .add("wizard with single apply button", function (_props) { return (react_1.default.createElement(storybook_state_1.State, { store: store }, function (state) { return (react_1.default.createElement(react_1.default.Fragment, null,
    react_1.default.createElement(button_1.Button, { key: 0, primary: true, link: true, onClick: function () { return state.handleToggleWizard(Wizard_1.WizardSize.LARGE); } }, "OPEN WIZARD"),
    react_1.default.createElement(Wizard_1.default, { currentStepID: state.currentWizardStepID, key: 1, size: Wizard_1.WizardSize.LARGE, show: state.open, showPrevious: false, showNext: false, showComplete: true, showCancel: true, completeText: "Apply", title: "Wizard with single apply button", onClose: function () { return state.handleClose(); }, onComplete: function () { return state.handleComplete(); }, onNavigateTo: state.handleSelectStep },
        react_1.default.createElement(WizardStep_1.default, { id: 0, key: 0, name: "Page 1", valid: state.basicInfoValid, complete: state.basicInfoValid }),
        react_1.default.createElement(WizardStep_1.default, { id: 1, key: 1, name: "Page 2", valid: state.basicInfoValid, complete: state.basicInfoValid }),
        react_1.default.createElement(WizardStep_1.default, { id: 2, key: 2, name: "Page 3", valid: state.basicInfoValid, complete: state.basicInfoValid })))); })); });
